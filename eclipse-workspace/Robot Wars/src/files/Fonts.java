...
public class Fonts {
	...
	public static TrueTypeFont arial36;
	...
	{	
		// Used
		calibri14 = new TrueTypeFont(new Font("Calibri", Font.PLAIN, 14), false);
		...
		arial36 = new TrueTypeFont(new Font("Arial", Font.BOLD, 36), false);		
