...
public abstract class GameObject implements CoreValues
{
	...
	{
		takeDamage(amount, DamageType.NORMAL, source);
	}
	...
	public void takeDamage(float amount, DamageType type, GameObject source)
	{
		...
		if(curShield > damageRemaining)
		{
			...
			resolveDamage(actualDamageDone);
			return;
		}
		...
		{
			resolveDamage(actualDamageDone + damageRemaining);
	...
	public void resolveDamage(float damage)
	{
		if(Settings.showFloatText)
		{
			Game.addAnimation(new AnimFloatTextAttack(damage, this));
		}
