...
{	
	...
	// Frame Data
	public static final int FRAME_LIGHT_WEIGHT_MAX = 5;
	public static final float FRAME_LIGHT_SPEED_BASE = 1;
	public static final int FRAME_LIGHT_HEALTH_BASE = 40;
	
	public static final int FRAME_MEDIUM_WEIGHT_MAX = 7;
	public static final float FRAME_MEDIUM_SPEED_BASE = .5f;
	public static final int FRAME_MEDIUM_HEALTH_BASE = 70;

	public static final int FRAME_HEAVY_WEIGHT_MAX = 9;
	public static final float FRAME_HEAVY_SPEED_BASE = .25f;
	public static final int FRAME_HEAVY_HEALTH_BASE = 100;
	
	// Respawn
	public static final int RESPAWN_TIME_BASE = 600;
	...
	public final static float ROBOT_OVERCLOCK_RATE = ROBOT_COOL_RATE_BASE * 2;

	// Shields
	public static final int SHIELD_REGEN_FREQUENCY = 120;			// Every 120 ticks  (2 seconds)
	public static final int SHIELD_RECOVERY_TIME = 240;			// Amount of time without taking damage for shield to recover
}
